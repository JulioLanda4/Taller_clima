...
::: notes
Enfatizar que el taller no se centra en diseño bioclimático. El producto es una lectura técnica del clima usando un flujo reproducible.
:::
...
:::{.img-frame}
![](img/graficas-python/ema_temperatura_humedad.svg)
:::
:::
...
::: {.grid-2}
:::{.img-frame}
![](img/graficas-python/epw_temperatura_mensual.svg)
:::

:::{.img-frame}
![](img/graficas-python/epw_mapa_hora_mes_temperatura.svg)
:::
:::
...
4. Genera en Jupyter una gráfica de radiación mensual del EPW
:::
